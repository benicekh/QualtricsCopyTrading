...
var SCREENELEMENTS = {
  ...
  cash1: document.getElementById("table_PLAYER1_CASH"),
  assets1: document.getElementById("table_PLAYER1_ASSETS"),
  ...
  cash2: document.getElementById("table_PLAYER2_CASH"),
  assets2: document.getElementById("table_PLAYER2_ASSETS"),
  ...
  cash3: document.getElementById("table_PLAYER3_CASH"),
  assets3: document.getElementById("table_PLAYER3_ASSETS"),
  ...
  cash4: document.getElementById("table_PLAYER4_CASH"),
  assets4: document.getElementById("table_PLAYER4_ASSETS"),
  ...
  cash5: document.getElementById("table_PLAYER5_CASH"),
  assets5: document.getElementById("table_PLAYER5_ASSETS"),
  ...
  // Survey question for Copy treatment
  surveyField: document.getElementById("survey"),
  copyDecisionSurvey: document.getElementById("textInputCopy"),
  survey_submit: document.getElementById("BUTTON_SURVEY_SUBMIT"),
...
const update = function () {
  if (roundData.round !== Stages[0].rounds) {
...
SCREENELEMENTS.decision_nextbutton.onclick = function () {
  if (roundData.round === 0 && treatment === 3) {
...
const finalRound = function () {
  ...
  if (Stages[0].stage === "regular") {
    SCREENELEMENTS.eor.textContent = "Ënd of Phase: " + (phase + 1);
...
///// If final round unhide qualtrics next button
...
const updateRanks = function () {
  ...
  let round = "round_" + roundData.round;
  ...
  if (roundData.round != 0) {
    for (let i = 1; i <= 5; i++) {
      ...
      const cashKey = "cash" + i;
      const assetsKey = "assets" + i;
      ...
      const cashValue = playerData["c"] === 0 ? "0" : playerData["c"] || "";
      const assetsValue = playerData["a"] === 0 ? "0" : playerData["a"] || "";
      const returnValue =
      ...
      SCREENELEMENTS[cashKey].textContent = cashValue;
      SCREENELEMENTS[assetsKey].textContent = assetsValue;
...
// Copy treatment survey feedback funtion
let surveyQuestion = "";
SCREENELEMENTS.survey_submit.onclick = function () {
  const copySurvey = SCREENELEMENTS.copyDecisionSurvey.value;
  SCREENELEMENTS.decision_nextbutton.classList.remove("hidden");
  document.getElementById("chartdiv").classList.remove("hidden");
  document.getElementById("chartwrap").classList.remove("hidden");
  document.getElementById("survey").classList.add("hidden");
  surveyQuestion = textInputCopy.value;
